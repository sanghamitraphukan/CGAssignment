...
void LoadGLTextures() {
   ...
   if (!ImageLoad("C:/Users/Admin/earthday.bmp", image1)) {
      exit(1);
   }
...
image2 = new Image();
   ...
   // Load picture from file
   if (!ImageLoad("C:/Users/Admin/jupiter1.bmp", image2)) {
      exit(1);
   }
   ...
   // Load picture from file
   if (!ImageLoad("C:/Users/Admin/stars1.bmp", image3)) {
      exit(1);
   }
...
std::string t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12;
t1= "GALILIEO MISSION";
...
t3= "1BY19CS082";
output(t3.data(), t3.size(), 220,370,GLUT_BITMAP_HELVETICA_18);
t4= "PRERANA R BHAT";
output(t4.data(), t4.size(), 100,340,GLUT_BITMAP_HELVETICA_18);
t5= "MOHAMMED FUZAIL MALIK";
output(t5.data(), t5.size(), 220,340,GLUT_BITMAP_HELVETICA_18);
t11= "1BY19CS134";
output(t11.data(), t11.size(), 370,370,GLUT_BITMAP_HELVETICA_18);
t12= "SANGHAMITRA PHUKAN";
output(t12.data(), t12.size(), 370,340,GLUT_BITMAP_HELVETICA_18);
glColor3f(0.7,0.8,0);
t6= "UNDER THE GUIDANCE OF";
output(t6.data(), t6.size(), 210,250,GLUT_BITMAP_HELVETICA_18);
t10= "PROF.MUNESHWARA MS";
output(t10.data(), t10.size(), 215,230,GLUT_BITMAP_HELVETICA_18);
t8= "Assistant Prof.";
output(t8.data(), t8.size(), 215,210,GLUT_BITMAP_HELVETICA_18);
t9= "Department of CSE, BMSIT";
...
t2= "\"We choose to go to the Jupiter in this decade and do the other things, not because they are easy, but because they are hard\"";
...
t7= "space probes to the Moon, Venus, and Mars, and human spaceflight in low Earth orbit and ultimately to the Jupiter.";
output(t7.data(), t7.size(), 50,320,GLUT_BITMAP_HELVETICA_18);
t8= "Out of all the mankind achievements in the space race of the 20th century, it was said that the Galileo mission where humans finally ";
output(t8.data(), t8.size(), 60,280,GLUT_BITMAP_HELVETICA_18);
t9= "escaped from the earth�s gravity and landed on the Jupiter was the most groundbreaking and dominating milestone in the history of space travel.";
